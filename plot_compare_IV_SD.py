...
os.chdir(r"I:\2021\Test_3T_Nanogap_chip_4")

# configuration
chip = "Test_3T_Nanogap_chip_4"
eburn = "1_rtest"
mol = "4_sd_devices_post_dropcast"
mol_name = "4cnr-OMe 1to10 Sol"
...
ivsvgset_electroburn = ivset[ivset["folder"] == eburn]
...
for dev in devices:
    ...
    if data:
        ...
        fig.visualise(f"Figures_IV_SD/{chip}/{dev}.png")
